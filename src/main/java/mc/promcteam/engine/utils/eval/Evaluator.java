package mc.promcteam.engine.utils.eval;

import mc.promcteam.engine.NexEngine;
import mc.promcteam.engine.utils.eval.javaluator.DoubleEvaluator;
...
public class Evaluator {
    ...
    private static double javaluator(String exp) {
        try {
            ...
            NexEngine.get().error("[E1] Unable to evaluate '" + exp + "'. Trying with E0...");
            return eval(exp, 0);
        }
    }
