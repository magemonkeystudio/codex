...
import mc.promcteam.engine.utils.craft.api.ICraftRecipe;
import mc.promcteam.engine.utils.craft.api.IFurnaceRecipe;
    ...
    public void setItem64(@NotNull String path, @Nullable ItemStack item) {
        if (item == null) {
            ...
            try {
                ...
                NexEngine.get().getLogger().warning("Could not set Item64");
                e.printStackTrace();
            }
        }
    }
