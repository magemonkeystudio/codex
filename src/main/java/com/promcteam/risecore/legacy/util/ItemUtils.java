...
public class ItemUtils {
    ...
    public static ItemStack replaceText(ItemStack item, MessageData... replace) {
        ...
        if (im.getLore() != null && !im.getLore().isEmpty()) {
            ArrayList<String> newLore = im.getLore()
                    .stream()
...
//            }
        ...
        try {
            ...
            Bukkit.getLogger()
                    .severe("SpigotCore attempts to get a material by it's id. Please change it to a name. ID: " + mat);
            Thread.dumpStack();
     ...
     *
     * @param strs List of Strings to remove color from
    ...
    public static ArrayList<String> removeColors(List<String> strs) {
        ...
        ArrayList<String> ret =
                strs.stream().map(ItemUtils::removeColors).collect(Collectors.toCollection(ArrayList::new));
        return ret;
    }
