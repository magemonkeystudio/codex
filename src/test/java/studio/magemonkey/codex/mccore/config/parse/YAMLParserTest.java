...
class YAMLParserTest {
    ...
    @BeforeAll
    static void setUp() {
        engineMock = mockStatic(CodexEngine.class);
    ...
    void parse_parsesSapiDefaultConfig() {
        // Get fabled-config from classpath
        InputStream in = this.getClass().getClassLoader().getResourceAsStream("fabled-config.yml");
        assertNotNull(in);
