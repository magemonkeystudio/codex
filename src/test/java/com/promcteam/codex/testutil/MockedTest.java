package com.promcteam.codex.testutil;
...
public abstract class MockedTest {
    ...
    public void setupServer() {
        ...
        reflex.when(() -> Reflex.getClass(startsWith("com.promcteam"), anyString()))
                .thenCallRealMethod();
        reflex.when(() -> Reflex.getClass(startsWith("com.promcteam")))
                .thenCallRealMethod();
