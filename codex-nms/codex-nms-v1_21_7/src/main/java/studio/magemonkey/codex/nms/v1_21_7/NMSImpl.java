package studio.magemonkey.codex.nms.v1_21_7;
...
public class NMSImpl implements NMS {
    ...
    public HoverEvent getHoverEvent(@NotNull ItemStack itemStack) {
        net.minecraft.world.item.ItemStack nmsItem = CraftItemStack.asNMSCopy(itemStack);
        // ItemStack.b is the obfuscated NMS field for ItemStack.CODEC; MinecraftServer.ba() is registryAccess().
        ...
        JsonElement encoded = net.minecraft.world.item.ItemStack.b
                .encodeStart(RegistryOps.a(JsonOps.INSTANCE, MinecraftServer.getServer().ba()), nmsItem)
                .getOrThrow();
