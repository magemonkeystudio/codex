...
public class NMSImpl implements NMS {
    ...
    public double getDefaultDamage(@NotNull ItemStack itemStack) {
        ...
        Collection<AttributeModifier> modifiers = itemMeta.getAttributeModifiers(Attribute.ATTACK_DAMAGE);
    ...
    public double getDefaultSpeed(@NotNull ItemStack itemStack) {
        ...
        Collection<AttributeModifier> modifiers = itemMeta.getAttributeModifiers(Attribute.ATTACK_SPEED);
        if (modifiers == null || modifiers.isEmpty()) return 0;
    ...
    public double getDefaultArmor(@NotNull ItemStack itemStack) {
        ...
        Collection<AttributeModifier> modifiers = itemMeta.getAttributeModifiers(Attribute.ARMOR);
        if (modifiers == null || modifiers.isEmpty()) return 0;
    ...
    public double getDefaultToughness(@NotNull ItemStack itemStack) {
        ...
        Collection<AttributeModifier> modifiers = itemMeta.getAttributeModifiers(Attribute.ARMOR_TOUGHNESS);
        if (modifiers == null || modifiers.isEmpty()) return 0;
