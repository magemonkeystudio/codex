[![Build](https://github.com/magemonkeystudios/codex/actions/workflows/release.yml/badge.svg?branch=main)](https://repo.travja.dev/releases/studio/magemonkey/codex/1.1.1-R0.9-SNAPSHOT)
[![Build](https://github.com/magemonkeystudios/codex/actions/workflows/devbuild.yml/badge.svg?branch=dev)](https://repo.travja.dev/snapshots/studio/magemonkey/codex/1.1.1-R0.9-SNAPSHOT)
...
<dependency>
    ...
    <version>1.1.1-R0.9-SNAPSHOT</version>
</dependency>
```
